    ...
    <div class="grid grid-cols-[22.5rem_auto] h-screen">
        ...
        <div class="bg-white shadow relative">
            ...
            <div class="absolute bottom-0 w-full flex space-x-2 justify-center border-t p-2">
                ...
                <button class="font-semibold blue flex-1 rounded-lg p-2 text-white">Share to Story</button>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center w-full">
            ...
            <div v-else class="bg-white shadow p-3 rounded-lg w-3/5 h-5/6 relative">
                ...
                <div class="bg-black rounded-lg flex items-center justify-center absolute left-4 bottom-4 right-4 top-12 py-4">
                    <div v-if="chooseCreate == 'photo_story'" class="h-full flex flex-col items-center">
                        <div class="h-full aspect-[0.55] bg-red-300 rounded-lg border border-white flex justify-center items-center">
                            <img :src="tempImage" alt="" class="w-full cursor-pointer">
                        </div>
                        <div class="text-white">Select photo to drop or rotate</div>
                    </div>
